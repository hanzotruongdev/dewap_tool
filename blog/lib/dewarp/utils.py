...
def get_ordered_points(points):
    """Get points in the orders of [topleft, topright, bottomright, bottomleft] 
    """
...
def calculate_abc(A, B, C, d):
    """sub function for increase boundary box, ref increase_border function
    """
    n1, n2 = B-A
    M = (A+B)/2
